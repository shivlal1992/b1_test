    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">New Question
              <button onclick="history.back()" class="btn btn-sm btn-secondary" style="float:right;" >Go Back</button>
              </h5>

              <!-- General Form Elements -->
              <form class="row g-3 mt-2"  method="POST" action="{{route('question-create')}}" enctype="multipart/form-data">
                @csrf()
                ...
                <div class="col-12">
                  ...
                  <div class="input-group has-validation">
                  <textarea name="title" class="form-control" rows="5" cols="5" id="" placeholder="Enter Title" required></textarea>
                  </div>
                </div>
                ...
                <div class="col-6">
                  ...
                  <div class="input-group has-validation">
                  <textarea name="opt_a" class="form-control" rows="5" cols="5" id="" placeholder="Enter Option A" required></textarea>
                  </div>
                </div>
                <div class="col-6">
                  <label for="yourUsername" class="form-label">Option B</label>
                  <div class="input-group has-validation">
                  <textarea name="opt_b" class="form-control" rows="5" cols="5" id="" placeholder="Enter Option B" required></textarea>
                  </div>
                </div>
                <div class="col-6">
                  <label for="yourUsername" class="form-label">Option C</label>
                  <div class="input-group has-validation">
                  <textarea name="opt_c" class="form-control" rows="5" cols="5" id="" placeholder="Enter Option C" required></textarea>
                  </div>
                </div>
                <div class="col-6">
                  <label for="yourUsername" class="form-label">Option D</label>
                  <div class="input-group has-validation">
                  <textarea name="opt_d" class="form-control" rows="5" cols="5" id="" placeholder="Enter Option D" required></textarea>
                  </div>
                </div>
