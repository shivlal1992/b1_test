              ...
              <div class="card mb-3">
                <div class="d-flex justify-content-center py-4">
                  <a href="javascript:void(0);" class="logo d-flex align-items-center w-auto">
                    ...
                    <span class="d-none d-lg-block">BetaFX</span>
                  </a>
                </div>
                ...
                <div class="card-body">
                  ...
                  <div class="pb-2">
                    ...
                    <p class="text-center small">Enter your mobile & unique code to reset password</p>
                  </div>

                  <form class="row g-3 " method="POST" action="{{route('admin.checkAndVerify')}}" enctype="multipart/form-data">
                  @csrf()
                    <div class="col-12">
                    ...
                    <div class="col-12">
                      <label for="yourPassword" class="form-label">Unique Code</label>
                    ...
                    <div class="col-12">
                      <p class="small mb-0 text-center"><a href="{{route('admin.login')}}">Back to Login</a></p>
                    </div>
